...
export default function PersonalWorkView() {
  ...
  return <main className="mx-auto w-full max-w-6xl p-4 sm:p-6 space-y-4">
    ...
    <section id="work-preferences" className="scroll-mt-4 border-t pt-4"><WorkPreferences preference={preference} /></section>
  </main>;
}
