...
export const TRANSITIONS = {
  ...
  devis_envoye: ['attente_paiement', 'paye'],
...
export const PHASES_CLIENT = [
  ...
  { key: 'accord',       label: 'Votre accord',   statuts: ['attente_feu_vert', 'autorise', 'refuse_client'] },
  { key: 'preparation',  label: 'Préparation',    statuts: ['en_preparation'] },
  { key: 'paiement',     label: 'Paiement',       statuts: ['devis_envoye', 'attente_paiement', 'paye'] },
