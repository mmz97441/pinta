...
export const DOSSIER_TASKS = {
  reception: { label: 'Réception', title: 'Vérifier la réception' },
  accord: { label: 'Accord client', title: 'Suivre l’accord du client' },
  preparation: { label: 'Préparation', title: 'Préparer les colis' },
  documents: { label: 'Factures', title: 'Vérifier les factures' },
  devis: { label: 'Devis', title: 'Établir le devis' },
  paiement: { label: 'Paiement', title: 'Suivre le paiement' },
  expedition: { label: 'Expédition', title: 'Suivre l’expédition' },
  livraison: { label: 'Livraison', title: 'Suivre la livraison' },
};
