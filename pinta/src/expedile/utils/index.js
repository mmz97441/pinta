...
// ══════════ LIENS ══════════
export function tgLink(username, msg) {
  return `https://t.me/${username || 'expedile_bot'}`;
}
